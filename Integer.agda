...
addI ZI b = b
addI a ZI = a
addI (Pos x) (Pos y) = Pos (S (x + y))
addI (Neg x) (Neg y) = Neg (S (x + y))
...
multI ZI _ = ZI
multI _ ZI = ZI
multI (Pos a) (Pos b) = Pos (a + (b + (a * b)))
multI (Neg a) (Neg b) = Pos (a + (b + (a * b)))
multI (Pos a) (Neg b) = Neg (a + (b + (a * b)))
multI (Neg a) (Pos b) = Neg (a + (b + (a * b)))
